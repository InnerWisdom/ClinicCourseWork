...
namespace ClinicBusinessLogic.BusinessLogics
{
    ...
    {
        public static void CreateDoc(ExcelInfoDoctor info)
        {
                ...
                foreach (var disease in list)
                {
                    ...
                    for (var i = 0; i < disease.Count; i++)
                    {
                        InsertCellInWorksheet(new ExcelCellParameters
                        {
                            ...
                            ColumnName = "B",
                            RowIndex = rowIndex,
                            Text = info.Receipts[j].MedicineName.ToString(),
                            StyleIndex = 1U
                        });
                        InsertCellInWorksheet(new ExcelCellParameters
                        {
                            ...
                            ColumnName = "C",
                            RowIndex = rowIndex,
                            Text = info.Receipts[j].Dose.ToString(),
                            StyleIndex = 1U
                        });
                        InsertCellInWorksheet(new ExcelCellParameters
                        {
                            ...
                            ColumnName = "D",
                            RowIndex = rowIndex,
                            Text = info.Receipts[j].PerDose.ToString(),
                            StyleIndex = 1U
                        }); InsertCellInWorksheet(new ExcelCellParameters
                        {
                            Worksheet = worksheetPart.Worksheet,
                            ...
                            ColumnName = "E",
                            RowIndex = rowIndex,
                            Text = info.Receipts[j].DoctorId.ToString(),
                            StyleIndex = 1U
                        });
                        rowIndex++;
                        j++;
